...
export const StyledPrivateIcon = styled('span')(({ theme }) => ({
  position: 'absolute',
  right: '0',
  top: '0',
  borderRadius: '3px',
...
export const StyledListTableCell = styled(TableCell)(({ theme }) => ({
  padding:"0px",
...
export const StyledItemTitle = styled(Box)(({ theme }) => ({
  fontSize:'12px',
  textAlign: 'center',
  '& span':{
    textAlign: "center",
...
export const StyledItemInfoBox = styled(Box)(({ theme }) => ({
  width:'100%',
  height: '50px',
  overflow: 'hidden',
  borderRadius: '3px',
